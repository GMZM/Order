                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xl-6 col-md-7 text-center">
                                <div class="slider-content">
                                    ...
                                    <a href="detailsUI?id=30" class="slider-btn">查看详情</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xl-6 col-md-7 text-center">
                                <div class="slider-content">
                                    ...
                                    <a href="detailsUI?id=13" class="slider-btn">查看详情</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-xl-6 col-md-7 text-center">
                                <div class="slider-content">
                                    ...
                                    <h1>极致美食</h1>
                                    <p>新品享乐惠，品尝好滋味.</p>
                                    <a href="detailsUI?id=31" class="slider-btn">查看详情</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <!--=======  End of banner  =======-->
                            <div class="fl-slider tab-product-slider">
                                ...
                                <div class="fl-product">
                                    <div class="image">
                                        <a href="detailsUI?id=${product.id}">
