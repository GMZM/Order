                                            ...
                                            <tr>
                                                <td width="55%">
                                                    ...
                                                    <ul class="order_goods_list">
                                                        <li class="col01"><img src="${pageContext.request.contextPath}/${oi.productList.get(index).imageurl}" width="50px" height="50px"></li>
                                                        <li class="col02"><a href="foreDetailUI?id=${oi.productList.get(index).id}">${oi.productList.get(index).name},${oi.productList.get(index).price}</a></li>
                                                        <li class="col03">${oi.number}</li>
                                                        <li class="col04">$${oi.productList.get(index).price*oi.number}</li>
                                                        <li class="col04"><a href="javascript:;" onclick="pingjia(${oi.productList.get(index).id});">评价</a></li>
                                                    </ul>
                                                    </c:forEach>
                                                </td>
