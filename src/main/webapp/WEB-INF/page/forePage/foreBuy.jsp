                            ...
                            <c:forEach items="${orderItems}" var="orderItem">
                                <tr>
                                    <td class="pro-thumbnail">
                                        <a href="single-product.html"><img src="${pageContext.request.contextPath}/${orderItem.productList.get(index).imageurl}" class="img-fluid" alt="Product"></a>
                                    </td>
                                    <td class="pro-title"><a href="single-product.html">${orderItem.productList.get(index).name}</a></td>
                                    <td class="pro-price"><span>$${orderItem.productList.get(index).price}</span></td><
                                    <td class="pro-quantity"><div class="pro-qty"><span>${orderItem.number}</span></div></td>
                                    <td class="pro-subtotal"><span>$${orderItem.totalPrice}</span></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
